 ...
 */
public class SudokuCAM extends JFrame {
	...
	private class InputListener implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			...
			if (wincounter == GRID_SIZE * GRID_SIZE) {
				...
				if (difficulty <= 3 ) 
				{
					JOptionPane.showMessageDialog(null, ("Click ok to advance!" + time));
					difficulty += 1;
					ResetPuzzle();
					ResetDifficultyPuzzle(difficulty);
					SoundFX.init();
					SoundFX.volume = SoundFX.Volume.HIGH;
					SoundBGM.BGM.stop();
					SoundFX.WIN.play();
				...
				{
					JOptionPane.showMessageDialog(null, ("Congratulations! You win! Time taken: " + time));
					SoundFX.init();
					SoundFX.volume = SoundFX.Volume.HIGH;
					SoundBGM.BGM.stop();
					SoundFX.WIN.play();
			...
			if (health <= 0) {
				...
				JOptionPane.showMessageDialog(null, ("Click ok to retry"));	
				health = 10;
				ResetPuzzle();
				ResetDifficultyPuzzle(difficulty);
